    ...
    var that = {
      ...
      redraw:function(){
        ...
        particleSystem.eachEdge(function(edge, pt1, pt2){
          ...
          if (color!==undefined || weight!==undefined){
            ...
            //   ctx.strokeStyle = palette[edge.source.data.region] // цвет ребер
            //   // ctx.strokeStyle = "red"
            // }
      ...
      resize:function(){
        ...
        $(canvas).mousedown(function(e){
          ...
          // console.log(pos, p, nearest)
          
      		if (selected.node !== null && nearest.distance < 30){
        ...
        //   return false
          ...
          // console.log("up", dragged, dragged.node, selected)
